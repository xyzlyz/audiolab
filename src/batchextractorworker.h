...
public:
    ...
    BatchExtractorWorker(const QStringList& videoFiles, const QString& outputDir, const QString& httpHeaders = QString(), const QString& bitrate = QString("32k"));
...
private:
    ...
    QString m_bitrate; // 音频输出比特率，默认 32k
